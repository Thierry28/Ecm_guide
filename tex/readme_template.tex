...
\usepackage[top=3cm,bottom=2cm,left=1.5cm,right=1.5cm,headsep=60pt,a4paper]{geometry} % Page margins
...
%\thispagestyle{empty} % retire header


% ajoute entete : OK, mais avec Chapter à droite géré par ailleurs
% voir : https://www.overleaf.com/learn/latex/Headers_and_footers
\pagestyle{fancy}
...
% Affiche e-carnet de maternelle ds le header
%\chapter{e-carnet de maternelle}
%\chapter{} % masque chapter ds le header mais laisse List of Figures à droite
